    ...
    document.querySelector('form').addEventListener('submit', function(e){
        ...
        function adicionarTarefa(){
            ...
            <div class="tarefaEmSi">
                            ...
                            <textarea name="descricao" id="descricaoDaTarefa" rows="6" cols="25">${descricao}</textarea>
        ...
        function concluirTarefa(){
            const tarefaConcluida = document.createElement("botaoConcluir");
            tarefaConcluida.className = "botaoConcluir";
